...
/*点击事件 */
MachineWorkingDetalls:function(e){

    var nid = e.currentTarget.dataset.nid;//获取data信息
    console.log(nid);

    //wx所提供的跳转页面
    wx.navigateTo({
      url: '/pages/MachineWorkingDetall/MachineWorkingDetall?BluetoothStatus=' + this.data.BluetoothService 
      + "&IsConnect=" + this.data.IsConnect,//加上的内容(+ nid )为给这个传递的参数
    })
